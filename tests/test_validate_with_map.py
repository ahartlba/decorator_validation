...
class TestValidateMap(unittest.TestCase):
    def test_correct(self):
        ...
        @validate(bar=divisible_by_10, message=lambda x: isinstance(x, str), some_additional_info=None)
    ...
    def test_not_correct(self):
        ...
        @validate(bar=divisible_by_10, message=lambda x: isinstance(x, str), some_additional_info=lambda x: True)
        def foo(bar: int, message: str, some_additional_info: Dict):
            return True
    ...
    def test_none(self):
        ...
        @validate(bar=divisible_by_10, message=None, some_additional_info=None)
        def foo(bar: int, message: str, some_additional_info: Dict):
            return True
